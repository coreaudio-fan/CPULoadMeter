...
///
///	There is deliberately no Quit item. SwiftUI has no terminate action, and this is a regular app whose
///	application menu and Dock icon already offer Quit; see Design.md, B.1.
